...
public class ShowAttendanceRecordManagerSide extends AppCompatActivity {
    private RequestQueue requestQueue;
    private String startDate = "", endDate = "";
    private TextView startDateText, endDateText,titleText;
    private Button searchBtn;
    private String loggedInUserId, company_id;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_show_attendance_record_manager_side);
